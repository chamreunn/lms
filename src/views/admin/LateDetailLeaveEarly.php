                ...
                <form action="" class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-3 text-red">
                            <label class="form-label fw-bold">រយៈពេលចេញមុន</label>
            ...
            <div class="modal modal-blur fade" id="approved<?= $detail['id'] ?>" tabindex="-1" aria-modal="true"
                ...
                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/elms/actionLeaveEarly" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="exit" value="<?= $detail['leave_early'] ?>">
