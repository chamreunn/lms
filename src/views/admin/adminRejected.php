        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-red active" href="/elms/adminrejected">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
            ...
            <!-- filter  -->
            <div class="card-header">
                <form class="w-100 mb-0" action="/elms/adminrejected" method="POST">
                    <div class="row g-3">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                            <select type="text" class="form-select" id="select-status" name="type" tabindex="-1">
                                ...
                                <option data-custom-properties="&lt;span class=&quot;badge bg-info-lt&quot;"
                                    value="lateout" <?php echo (isset($_POST['type']) && $_POST['type'] == 'lateout') ? 'selected' : ''; ?>>
                                    ចេញយឺត
                                </option>
                        ...
                        <div class="col-lg-1">
                            <a href="/elms/adminrejected" type="reset" class="btn btn-outline w-100">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round"
            ...
            <!-- end filter  -->
            <?php if (empty($getRejectedAll)): ?>
                <div class="text-center text-red">
                    <img src="public/img/icons/svgs/empty.svg" alt="">
                    <h3 class="mb-4">មិនមានសំណើដែលមិនអនុម័ត។</h3>
                </div>
            <?php else: ?>
                ...
                <?php if (!empty($getRejectedAll)): ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter table-bordered-less table-striped sortable-table mb-0">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($getRejectedAll as $attendance): ?>
                                    <tr>
                                        <td>
