                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3">
                            <select type="text" class="form-select" id="select-status" name="status" tabindex="-1">
                                ...
                                <option data-custom-properties="&lt;span class=&quot;badge bg-warning&quot;"
                                    value="Pending" <?php echo (isset($_POST['status']) && $_POST['status'] == 'Pending') ? 'selected' : ''; ?>>
                                    Pending
                                </option>
                                <option data-custom-properties="&lt;span class=&quot;badge bg-green&quot;"
                                    value="Approved" <?php echo (isset($_POST['status']) && $_POST['status'] == 'Approved') ? 'selected' : ''; ?>>
                                    Approved
                                </option>
                                <option data-custom-properties="&lt;span class=&quot;badge bg-danger&quot;"
                                    value="Rejected" <?php echo (isset($_POST['status']) && $_POST['status'] == 'Rejected') ? 'selected' : ''; ?>>
                                    Rejected
                                </option>
                            </select>
                        </div>
