                            ...
                            <?php foreach ($getAllMissions as $key => $mission): ?>
                                <tr>
                                    ...
                                    <td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/elms/update-mission" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="userId" value="<?= $mission['user_id'] ?>">

                                                            <div class="mb-3">
                                                                <label for="emission_start" class="form-label">ឈ្មោះបេសកកម្ម<span
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-icon">
                                                                    ...
                                                                    <input disabled type="text"
                                                                        value="<?= $mission['num_date'] ?>ថ្ងៃ" class="form-control"
                                                                        id="emission_end" name="end_date" required>
                                                                </div>
                                                            </div>
                                        ...
                                        <!-- delete  -->
                                        <div class="modal modal-blur fade" id="deleteModal<?= htmlspecialchars($mission['id']) ?>"
