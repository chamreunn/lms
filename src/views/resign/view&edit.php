...
<div class="row g-3">
    ...
    <div class="col-lg-8 col-sm-12 col-md-12">
        ...
        <?php if ($getResignById[0]['status'] == 'approved'): ?>
            <div class="card">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" name="holdId"
                                        value="<?= $getResignById[0]['id'] ?? '' ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="start_date" class="form-label fw-bold text-primary">ថ្ងៃចាប់ផ្តើម</label>
                                    <input type="text" class="form-control date-picker" id="start_date" name="start_date"
                                        value="<?= $getResignById[0]['start_date'] ?? '' ?>"
                                        <?= ($getResignById[0]['status'] === 'approved' ? '' : '') ?> required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control date-picker" id="end_date" name="end_date"
                                        value="<?= $getResignById[0]['end_date'] ?? '' ?>"
                                        <?= ($getResignById[0]['status'] === 'approved' ? '' : '') ?> required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="created_at" id="created_at"
                                        value="<?= $getResignById[0]['created_at'] ?? '' ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="duration" class="form-control" id="duration"
                                        value="<?= $getResignById[0]['duration'] ?? '' ?>">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="reason" class="form-label fw-bold text-primary">មូលហេតុ</label>
                                <textarea class="form-control" id="reason" name="reason"
                                    <?= ($getResignById[0]['status'] === 'approved' ? '' : '') ?>
                                    required><?= $getResignById[0]['reason'] ?? '' ?></textarea>
                            </div> -->
                        </div>
                            ...
                            <label class="form-selectgroup-item flex-fill">
                                ...
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    ...
                                    <div>
                                        ...
                                        សំណើសុំស្ថិតនៅក្នុងភាពទំនេរគ្មានបៀវត្ស.pdf
                                    </div>
                                </div>
                            </label>
                        </div>
