...
$customButton = '
    <div class="d-flex">
        ...
        <a href="#" data-bs-toggle="modal" data-bs-target="#backwork" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal"
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="modal modal-blur fade"
                                                id="delete<?= htmlspecialchars($backwork['id']) ?>" tabindex="-1" role="dialog"
                                                aria-hidden="true">
