...
$customButton = '
    <div class="d-flex">
        ...
        <a href="#" data-bs-toggle="modal" data-bs-target="#hold" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal"
                                ...
                                <tr>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <div class="modal modal-blur fade"
                                                        id="deleted<?= htmlspecialchars($hold['id']) ?>" tabindex="-1" role="dialog"
                                                        aria-hidden="true">
                                    ...
                                    <td class="d-none d-xl-table-cell">
                                        <div class="d-flex">
                                            ...
                                            <!-- delete hold modal  -->
                                            <div class="modal modal-blur fade" id="delete<?= htmlspecialchars($hold['id']) ?>"
