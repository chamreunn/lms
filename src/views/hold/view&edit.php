...
$customButton = '
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="/elms/hold">លិខិតព្យួរ</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control date-picker" id="start_date" name="start_date"
                                    value="<?= $getHoldById[0]['start_date'] ?? '' ?>"
                        ...
                        <div class="row" hidden>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control date-picker" id="start_date" name="start_date"
                                        value="<?= $getHoldById[0]['start_date'] ?? '' ?>"
                                        <?= ($getHoldById[0]['status'] === 'approved' ? '' : '') ?> required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="created_at" id="created_at"
                                        value="<?= $getHoldById[0]['created_at'] ?? '' ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="duration" class="form-control" id="duration"
                                        value="<?= $getHoldById[0]['duration'] ?? '' ?>">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="reason" class="form-label fw-bold text-primary">មូលហេតុ</label>
                                <textarea class="form-control" id="reason" name="reason"
                                    <?= ($getHoldById[0]['status'] === 'approved' ? '' : '') ?>
                                    required><?= $getHoldById[0]['reason'] ?? '' ?></textarea>
                            </div>
                        </div>
