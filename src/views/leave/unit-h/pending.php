                    ...
                    <div class="modal modal-blur fade" id="detailModal<?= $index ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <!-- detail section  -->
                                <form action="/elms/huaction<?= $holds['type'] ?>" method="POST">
            ...
            <div class="modal modal-blur fade" id="detailModal<?= $index ?>" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- detail section  -->
                        <form action="/elms/huaction<?= $transferout['type'] ?>" method="POST">
                            <div class="col-12" hidden>
            ...
            <div class="modal modal-blur fade" id="detailModalResign<?= $index ?>" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        ...
                        <!-- detail section  -->
                        <form action="/elms/huaction<?= $resign['type'] ?>" method="POST">
