        ...
        <div class="row g-2 align-items-center">
            <div class="col text-primary">
                ...
                <div class="page-pretitle">
                    <a href="/elms/dashboard">ទំព័រដើម</a>
                </div>
                <h2 class="page-title">
                    <?php echo $title ?? "" ?>
                </h2>
                ...
                <?php if (empty($paginatedRequests)) : ?>
                    <tr>
                        <td colspan="7" class="text-center">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#unit-apply" class="btn btn-primary mb-3" >
                    ...
                    <?php foreach ($paginatedRequests as $request) : ?>
                        <tr>
                            ...
                            <td class="p-0 text-center">
                                <a href="/elms/view-leave?leave_id=<?= $request['id'] ?>" title="ពិនិត្យមើល" data-bs-placement="auto" data-bs-toggle="tooltip" class="icon me-2 p-0 edit-btn">
