            ...
            <div class="col-md-6 col-lg-3 mb-3">
                <div class="card h-100 p-0 border">
                    <div class="card-body p-3">
                        <div class="ribbon bg-red" style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">កំពុងរង់ចាំអនុម័ត...</div>
