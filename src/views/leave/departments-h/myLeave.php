...
$customButton = '
    <div class="d-flex">
        <a href="#" data-bs-toggle="modal" data-bs-target="#head-of-department"
        ...
        <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal"
            data-bs-target="#head-of-department" aria-expanded="false">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                stroke-linecap="round" stroke-linejoin="round">
...
<div class="card rounded-3">
    ...
    <div class="card-body border-bottom">
        <form class="mb-0" action="/elms/hdepartmentLeave" method="POST">
            <div class="row align-items-center">
                ...
                <div class="col mb-3">
                    <a href="/elms/hdepartmentLeave" type="reset" class="btn w-100 btn-danger">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <tr>
                        <td colspan="8" class="text-center">
                            ...
                            <a class="btn btn-primary d-none d-sm-inline-block mb-3" data-bs-toggle="modal"
                                data-bs-target="#head-of-department">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <a href="#" class="btn btn-primary d-sm-none btn-icon mb-3"
                                data-bs-toggle="modal" data-bs-target="#head-of-department">
                    ...
                    <?php foreach ($requests as $request): ?>
                        <tr>
                            ...
                            <td class="text-center p-0">
                                <a href="/elms/view-leave-detail-dh?leave_id=<?= htmlspecialchars($request['id']) ?>"
                        ...
                        <div class="modal modal-blur fade" id="deleteModal<?= htmlspecialchars($request['id']) ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="/elms/hdepart-delete" method="POST">
