    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <div class="d-flex">
                        <a class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#user-apply">
                        ...
                        <a href="/elms/apply-leave" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#user-apply">
...
<div class="card rounded-3">
    ...
    <div class="card-body border-bottom">
        <form class="mb-0" action="/elms/my-leaves" method="POST">
            <div class="row align-items-center">
                ...
                <div class="col mb-3">
                    <a href="/elms/my-leaves" type="reset" class="btn w-100 btn-danger">
                ...
                <?php if (empty($paginatedRequests)) : ?>
                    <tr>
                        <td colspan="8" class="text-center">
                            ...
                            <a class="btn btn-primary d-none d-sm-inline-block mb-3" data-bs-toggle="modal" data-bs-target="#user-apply">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-plus">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M12.5 21h-6.5a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v5" />
                                    <path d="M16 3v4" />
                            ...
                            <a href="/elms/apply-leave" class="btn btn-primary d-sm-none btn-icon mb-3" data-bs-toggle="modal" data-bs-target="#user-apply">
                                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <line x1="12" y1="5" x2="12" y2="19"></line>
