            ...
            <div class="card-header">
                ...
                <?php if ($request['status'] !== 'Approved') : ?>
                    <div class="ms-auto mb-0">
                        <button class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#cancelModal">បោះបង់សំណើ</button>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li>
                                        <a class="dropdown-item mb-0" href="#" onclick="Export2Word('page-contents<?= $request['id'] ?>', 'ច្បាប់ឈប់សម្រាក <?= $request['khmer_name'] ?>');">
