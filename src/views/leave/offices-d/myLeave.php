...
$customButton = '
    <div class="d-flex">
        ...
        <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal"
            data-bs-target="#do-apply" aria-expanded="false">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                stroke-linecap="round" stroke-linejoin="round">
...
<div class="card rounded-3">
    ...
    <div class="card-body border-bottom">
        <form class="mb-0" action="/elms/dofficeLeave" method="POST">
            <div class="row align-items-center">
                ...
                <div class="col mb-3">
                    <a href="/elms/dofficeLeave" type="reset" class="btn w-100 btn-danger">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <?php else: ?>
                    <?php foreach ($requests as $request): ?>
                        <tr>
                            ...
                            <td class="p-0">
                                <a href="/elms/view-leave-detail-d?leave_id=<?= htmlspecialchars($request['id']) ?>"
