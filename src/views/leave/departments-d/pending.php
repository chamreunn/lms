                    ...
                    <div class="modal modal-blur fade" id="detailModal<?= $index ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <!-- detail section  -->
                                <form action="/elms/ddaction<?= $holds['type'] ?>" method="POST">
                                    ...
                                    <div class="col-12" hidden>
                                        ...
                                        <input type="text" class="form-control" name="start_date"
                                            value="<?= $holds['start_date'] ?>">
                                        <input type="text" class="form-control" name="end_date"
                                            value="<?= $holds['end_date'] ?>">
                                        <input type="text" class="form-control" name="duration"
                                            value="<?= $holds['duration'] ?>">
            ...
            <div class="modal modal-blur fade" id="detailModal<?= $index ?>" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- detail section  -->
                        <form action="/elms/ddaction<?= $transferout['type'] ?>" method="POST">
                            <div class="col-12" hidden>
            ...
            <div class="modal modal-blur fade" id="detailModal<?= $index ?>" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- detail section  -->
                        <form action="/elms/ddaction<?= $backwork['type'] ?>" method="POST">
                            <div class="col-12" hidden>
            ...
            <div class="modal modal-blur fade" id="detailModalResign<?= $index ?>" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        ...
                        <!-- detail section  -->
                        <form action="/elms/ddaction<?= $resign['type'] ?>" method="POST">
