                    ...
                    <div class="card-body p-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="mb-2">
                                        ...
                                        <?= $request['status'] == 'Cancelled' ? 'bg-secondary-lt' : '' ?>">
                                            <i class="fas fa-<?= $request['status'] == 'Pending' ? 'clock' : ($request['status'] == 'Approved' ? 'check' : ($request['status'] == 'Rejected' ? 'times' : 'ban')) ?>"></i>
                                            <?= $request['status'] ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="p-2">
                            <div class="text-primary mb-2">
                                ...
                                <strong>ស្នើនៅ : </strong><?= translateDateToKhmer($request['created_at'], 'j F Y h:i A') ?>
                            </div>
                            <div class="text-primary mb-2">
