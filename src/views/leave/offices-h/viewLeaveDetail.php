                ...
                <div class="pdf-page size-a4">
                    ...
                    <div class="page-body">
                        ...
                        <p
                            ...
                            <strong class="h3">កម្មវត្ថុ៖</strong>
                            <span style="text-indent: 50px;">សំណើសុំច្បាប់ឈប់សម្រាកចំនួន
                        ...
                        <p
                            ...
                            <?php foreach ($depoffice['ids'] as $index => $id): ?>
                                ...
                                មុខងារបច្ចុប្បន្ន <?= $depoffice['roleName'][$index] ?> នៃ
                                <?= $depoffice['departmentName'][$index] ?>
                                ដើម្បីបំពេញភារៈកិច្ចជំនួសជាប្រធានការិយាល័យស្តីទី។
                            <?php endforeach; ?>
                        </p>
                        <p style="font-family: khmer mef1; font-size:16px; text-align:justify; text-indent: 50px; margin-bottom: -20px;">
                            ...
                            <?php if (!empty($request['dunit'])): ?>
                                <?php foreach ($request['dunit'] as $approval): ?>
                                    <div class="col-6"
                                        ...
                                        <p class="fw-bold" style="margin-bottom: 0;">
                                            <?= htmlspecialchars(($approval['position_name']), ENT_QUOTES, 'UTF-8') ?>
                                        </p>
                                        <h3
                                            class="<?= ($approval['approver_status'] ?? '') === 'Approved' ? 'text-success' : 'text-danger' ?>">
                                            <?php
