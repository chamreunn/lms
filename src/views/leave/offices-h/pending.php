...
?>
<!-- leave requests  -->
<?php if (empty($requests) && empty($hold) && empty($transferouts) && empty($backwork)): ?>
    <div class="card">
        <div class="card-body">
                                        ...
                                        <div class="col-12" hidden>
                                            ...
                                            <select class="form-select select-people" id="transfer_id_hof" name="approverId"
                                                ...
                                                <?php if (isset($approver['ids'][0])): ?>
                                                    <option
                                                        value="<?= htmlspecialchars($approver['ids'][0], ENT_QUOTES, 'UTF-8') ?>"
                                        ...
                                        <div class="modal-body">
                                            <div class="row mb-3 g-3">
                                                <div class="col-12 text-center">
                                                    ...
                                                    <img src="<?= $holds['profile'] ?>" alt="User Profile"
                ...
                <div class="modal modal-blur fade" id="detailModal<?= $index ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <!-- detail section  -->
                            <form action="/elms/hoaction<?= $transferout['type'] ?>" method="POST">
                                <div class="col-12" hidden>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="bg-light p-3 rounded-3">
                                        <div class="col-12 text-center mb-3">
                                            <!-- User Profile Picture -->
                                            <img src="<?= $transferout['profile'] ?>" alt="User Profile"
                                                class="avatar avatar-xl" style="object-fit: cover;">
                                        </div>
                                        <dl class="row g-1 mb-0">
                                            <dt class="col-sm-12 col-md-4"><strong>ឈ្មោះ:</strong></dt>
                ...
                <div class="modal modal-blur fade" id="detailModal<?= $index ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <!-- detail section  -->
                            <form action="/elms/hoaction<?= $backwork['type'] ?>" method="POST">
                                <div class="col-12" hidden>
                ...
                <div class="modal modal-blur fade" id="detailModalResign<?= $index ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-md">
                        <div class="modal-content">
                            ...
                            <!-- detail section  -->
                            <form action="/elms/hoaction<?= $resign['type'] ?>" method="POST">
