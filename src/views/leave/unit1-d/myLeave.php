    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <div class="d-flex">
                        <a class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#du1-apply-leave">
                        ...
                        <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#du1-apply-leave">
...
<!-- Modal Apply Leave -->
<div class="modal modal-blur fade" id="du1-apply-leave" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<div class="card rounded-3">
    ...
    <div class="card-body border-bottom">
        <form class="mb-0" action="/elms/dunit1Leave" method="POST">
            <div class="row align-items-center">
                ...
                <div class="col mb-3">
                    <a href="/elms/dunit1Leave" type="reset" class="btn w-100 btn-danger">
                        ...
                        <div class="modal modal-blur fade" id="deleteModal<?= htmlspecialchars($request['id']) ?>" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="/elms/dunit1-delete" method="POST">
