	...
	<div class="card mb-3">
		<div class="card-body">
			<div class="row g-3 align-items-center mb-3">
				<div class="col-auto">
					<img src="<?= $_SESSION['user_profile'] ?>" alt="" style="object-fit: cover;" class="avatar avatar-md">
				</div>
            ...
            <div class="col-12">
                <div class="alert alert-success" role="alert">
                    ...
                    <a href="/elms/view-leave-detail?leave_id=<?= $leave['id'] ?>" class="text-success text-decoration-none"
                        ...
                        title="កាលបរិច្ឆេទចាប់ពី <?= translateDateToKhmer($leave['start_date'], 'd F Y') ?> ដល់ <?= translateDateToKhmer($leave['end_date'], 'd F Y') ?>">ច្បាប់ឈប់សម្រាករបស់អ្នកត្រូវាបាន
    ...
    <div class="col-12 mb-3">
        <div class="row row-cards">
            ...
            <div class="col-sm-6 col-lg-3">
                <a href="/elms/hunitLeave" class="card card-sm">
...
<div class="row row-card mb-3 g-3">
    <?php if (count($getUserApprove) > 0): ?>
        <div class="col-12 col-sm-12 col-md-6 col-lg-12 mb-3">
            <h3 class="mb-3 text-start text-md-left text-primary">ស្ថានភាពអវត្តមានសម្រាប់ថ្ងៃនេះ<span
    ...
    <?php if (count($getLateIn) > 0): ?>
        <div class="col-12 col-sm-12 col-md-6 col-lg-12 mb-3">
            <h3 class="mb-3 text-start center text-md-left text-primary">ស្ថានភាពចូលយឺតសម្រាប់ថ្ងៃនេះ<span
                    class="mx-2 text-primary"><?= date('Y-m-d') ?></span></h3>
            <div class="card">
                <div class="list-group list-group-flush overflow-auto" style="max-height: 35rem">
