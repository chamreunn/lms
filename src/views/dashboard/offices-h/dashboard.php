        ...
        <div class="card">
            <div class="list-group list-group-flush overflow-auto" style="max-height: 35rem">
                <?php foreach ($getUserApprove as $request) : ?>
                    <a href="/elms/view-leave-detail?leave_id=<?= $request['leave_request_id'] ?>" class="list-group-item list-group-item-action border-left-light">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="text-muted text-truncate mt-n1">ឈប់សម្រាក ចំនួន <strong class="text-success"><?= $request['num_date'] ?></strong> ថ្ងៃ ចាប់ពី <strong class="text-success"><?= $request['start_date'] ?></strong> ដល់ <strong class="text-success"><?= $request['end_date'] ?></strong></small>
                            </div>
                        </div>
                        <!-- </div> -->
                    </a>
...
<div class="row row-card mb-3">
    <div class="col-lg-3 mb-3">
        <a href="" data-bs-toggle="modal" data-bs-target="#office-apply-leave" class="card card-link card-link-pop text-primary p-5 d-flex align-items-center justify-content-center">
    ...
    <div class="col-lg-3 mb-3">
        <a href="" data-bs-toggle="modal" data-bs-target="#apply-left-before" class="card card-link card-link-pop p-5 text-warning d-flex align-items-center justify-content-center">
            <div class="avatar mb-3 bg-warning-lt">
    ...
    <div class="col-lg-3 mb-3">
        <a href="" data-bs-toggle="modal" data-bs-target="#apply-mission" class="card card-link card-link-pop p-5 d-flex align-items-center justify-content-center text-indigo">
...
<!-- Modal Apply Leave -->
<div class="modal modal-blur fade" id="office-apply-leave" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
