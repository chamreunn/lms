    ...
    <div class="col">
        <div class="alert alert-info alert-dismissible mb-3" role="alert">
            <div class="d-flex">
                ...
                <a href="/elms/pending">
                    អ្នកមានច្បាប់ដែលមិនទាន់អនុម័តចំនួន <span class="badge bg-red text-red-fg ms-2 fw-bolder"><?= $requestscount ?></span>
                </a>
            </div>
    ...
    <div class="col">
        <div class="alert alert-info alert-dismissible mb-3" role="alert">
            <div class="d-flex">
                ...
                <div>
                    <a href="/elms/mission">
                        អ្នកមានបេសកម្មនៅថ្ងៃនេះ <span class="badge bg-red text-red-fg ms-2 fw-bolder"><?= count($getMissionToday) ?></span>
                    </a>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="/elms/dof-apply-leave" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="leave_type" class="form-label fw-bold">ប្រភេទច្បាប់<span class="text-success mx-1 fw-bold">*</span></label>
