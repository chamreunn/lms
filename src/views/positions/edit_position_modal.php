<div class="modal modal-blur fade" id="modal-edit-position" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="/elms/update_position" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Choose Color<span class="text-danger fw-bold mx-1">*</span></label>
                        <div class="mb-3">
                            <div class="row g-2">
                                <div class="col-auto">
                                    <label class="form-colorinput">
                                        <input name="color" type="radio" value="bg-dark" class="form-colorinput-input" id="editColor1">
