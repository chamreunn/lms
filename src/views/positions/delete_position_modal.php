<div class="modal modal-blur fade" id="modal-delete-position" tabindex="-1" position="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" position="document">
        <div class="modal-content">
            <div class="modal-status bg-danger"></div>
            <form action="/elms/delete_position" method="POST">
                <div class="modal-body text-center py-4 mb-0">
                    <input type="hidden" name="id" id="delete-position-id">
                    ...
                    <h5 class="modal-title fw-bold text-danger">Delete Position</h5>
                    <p class="mb-0">Are you sure you want to delete this Position?</p>
                </div>
