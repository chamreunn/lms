    ...
    <div class="card rounded-3">
        ...
        <?php if (empty($getleaveearly)): ?>
            <div class="text-center mb-3">
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#apply-leaveearly" class="btn btn-primary">
        ...
        <?php else: ?>
            ...
            <div class="table-responsive">
                <table id="officeTable" class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        <?php foreach ($getleaveearly as $key => $getlate): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <button class="btn d-sm-none btn-link p-0 me-2" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" class="icon icon-tabler icon-tabler-plus mx-2">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    ...
                                    <div id="details<?= $getlate['id'] ?>" class="collapse d-sm-block d-xl-none mt-2">
                                        <div class="mb-1"><strong>ម៉ោង:</strong> <?= $getlate['leave_early'] ?></div>
                                        ...
                                        <div class="mb-0">
                                            <?php if ($getlate['status'] == 'Approved'): ?>
                                                ...
                                                <!-- delete  -->
                                                <div class="modal modal-blur fade" id="deleteLateEarliess<?= $getlate['id'] ?>"
                                                                ...
                                                                <div class="modal-footer bg-light border-top">
                                                                    <div class="w-100">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col">
                                                                                <button type="submit"
                                                                                    class="btn btn-danger ms-auto w-100">លុប</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <?php else: ?>
                                                <a href="#" class="icon me-2 edit-btn text-info"
                                                    data-bs-target="#editleaveearlys<?= $getlate['id'] ?>" data-bs-toggle="modal">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <a href="#" class="icon me-2 edit-btn text-danger"
                                                    data-bs-target="#deleteLateEarlies<?= $getlate['id'] ?>" data-bs-toggle="modal">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round"
                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-trash">
                                                ...
                                                <!-- edit leave early responsive -->
                                                <div class="modal modal-blur fade" id="editleaveearlys<?= $getlate['id'] ?>"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST" action="/elms/edit_leaveearly"
                                                ...
                                                <!-- delete  -->
                                                <div class="modal modal-blur fade" id="deleteLateEarlies<?= $getlate['id'] ?>"
                                                    tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-status bg-danger"></div>
                                ...
                                <td class="d-none d-xl-table-cell text-red"><?= $getlate['leave_early'] ?></td>
                                ...
                                <td class="d-none d-xl-table-cell">
                                    <?php if ($getlate['status'] == 'Approved'): ?>
                                        ...
                                        <a href="#" class="icon me-2 edit-btn text-danger"
                                            data-bs-target="#deleteleaveearlys<?= $getlate['id'] ?>" data-bs-toggle="modal">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"
                                                class="icon icon-tabler icons-tabler-outline icon-tabler-trash">
                                        ...
                                        <!-- delete  -->
                                        <div class="modal modal-blur fade" id="deleteleaveearlys<?= $getlate['id'] ?>" tabindex="-1"
                                    ...
                                    <?php else: ?>
                                        <a href="#" class="icon me-2 edit-btn text-info"
                                            data-bs-target="#editleaveearly<?= $getlate['id'] ?>" data-bs-toggle="modal">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"
                                                class="icon icon-tabler icons-tabler-outline icon-tabler-edit">
                                        ...
                                        <a href="#" class="icon me-2 edit-btn text-danger"
                                            data-bs-target="#deleteleaveearly<?= $getlate['id'] ?>" data-bs-toggle="modal">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"
                                                class="icon icon-tabler icons-tabler-outline icon-tabler-trash">
                                        ...
                                        <!-- edit leave early  -->
                                        <div class="modal modal-blur fade" id="editleaveearly<?= $getlate['id'] ?>" tabindex="-1"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 mb-3">
                                                                    ...
                                                                    <div class="input-icon">
                                                                        ...
                                                                        <input type="text" autocomplete="off"
                                                                            value="<?= $getlate['leave_early'] ?>"
                                                                            placeholder="ម៉ោង" class="form-control time-picker"
                                                                            name="time">
                                                                    </div>
                                                                </div>
                                                                <div class="col-12 mb-3">
                                        ...
                                        <!-- delete  -->
                                        <div class="modal modal-blur fade" id="deleteleaveearly<?= $getlate['id'] ?>" tabindex="-1"
                                            role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-status bg-danger"></div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 mb-2 mt-3"
                                                            ...
                                                            <p style="white-space: nowrap;">បានចេញពីបំពេញការងារវេលាម៉ោង
                                                                <?= convertToKhmerNumerals($getlate['leave_early'] . "នាទី") ?>
                                                            </p>
