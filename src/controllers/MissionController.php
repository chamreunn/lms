    ...
    public function create()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            try {
                ...
                $missionModel = new MissionModel();
                $createMissionResult = $missionModel->create($user_id, $start_date, $end_date, $attachment_name, $duration_days);
                ...
                $_SESSION['error'] = [
                    'title' => "កំហុស",
                    'message' => "មានបញ្ហាក្នុងការបង្កើតសំណើឈប់សម្រាក: " . $e->getMessage()
                ];
            }
    ...
    public function update($mission_id)
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            try {
                ...
                // Update mission
                $missionModel = new MissionModel();
                $updateMissionResult = $missionModel->update($mission_id, $user_id, $start_date, $end_date, $attachment_name, $duration_days);
