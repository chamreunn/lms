...
class DepDepartController
{
    ...
    public function approve()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $leaveApproval = new DepDepartLeave();
            ...
            require 'src/views/leave/depdepartmentapproval.php';
        }
    }
    ...
    public function approved()
    {
        ...
        require 'src/views/leave/depdepartmentapproved.php';
    }
