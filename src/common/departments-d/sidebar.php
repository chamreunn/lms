        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item <?= ($current_page == 'ddepartmentLeave' || $current_page == 'view-leave-detail') ? 'active' : '' ?>">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item <?= ($current_page == 'depdepartmentrejected') ? 'active' : '' ?>" href="/elms/depdepartmentrejected">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block">
