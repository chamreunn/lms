        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li
                        class="nav-item <?= ($current_page == 'ddepartmentLeave' || $current_page == 'view-leave-detail') ? 'active' : '' ?>">
                        <a class="nav-link" href="/elms/ddepartmentLeave">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <!-- All Request  -->
                    <li
                        class="nav-item dropdown <?= in_array($current_page, ['depdepartmentpending', 'depdepartmentapproved', 'depdepartmentrejected', 'holdApproved', 'holdRejected']) ? 'active' : '' ?>">
                        <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                            data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item <?= ($current_page == 'depdepartmentpending') ? 'active' : '' ?>"
                                        href="/elms/depdepartmentpending">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="dropend">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="/elms/depdepartmentapproved"
                                                class="dropdown-item <?= in_array($current_page, ['depdepartmentapproved']) ? 'active' : '' ?>">
                                                <span>បានអនុម័ត</span>
                                            </a>
                                            <a href="/elms/depdepartmentrejected"
                                                class="dropdown-item <?= in_array($current_page, ['depdepartmentrejected']) ? 'active' : '' ?>">
                                                <span>មិនអនុម័ត</span>
                                            </a>
                                        </div>
                                    </div>
