        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li
                        class="nav-item <?= ($current_page == 'hdepartmentLeave' || $current_page == 'view-leave-detail') ? 'active' : '' ?>">
                        <a class="nav-link" href="/elms/hdepartmentLeave">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <!-- All Request  -->
                    <li
                        class="nav-item dropdown <?= in_array($current_page, ['headdepartmentpending', 'headdepartmentapproved', 'headdepartmentrejected', 'holdApproved', 'holdRejected']) ? 'active' : '' ?>">
                        <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                            data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item <?= ($current_page == 'headdepartmentpending') ? 'active' : '' ?>"
                                        href="/elms/headdepartmentpending">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <!-- leave   -->
                                    <div class="dropend">
                                        <a class="dropdown-item dropdown-toggle <?= in_array($current_page, ['headofficeapproval', 'rejected']) ? 'active' : '' ?>"
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="/elms/headdepartmentapproved"
                                                class="dropdown-item <?= in_array($current_page, ['headdepartmentapproved']) ? 'active' : '' ?>">
                                                <span>បានអនុម័ត</span>
                                            </a>
                                            <a href="/elms/headdepartmentrejected"
                                                class="dropdown-item <?= in_array($current_page, ['headdepartmentrejected']) ? 'active' : '' ?>">
                                                <span>មិនអនុម័ត</span>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <li class="nav-item <?= ($current_page == 'department-calendar') ? 'active' : '' ?>">
                        <a class="nav-link" href="/elms/department-calendar">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round"
