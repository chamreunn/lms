        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <!-- All Request  -->
                    <li
                        class="nav-item dropdown <?= in_array($current_page, ['dunit1pending', 'dunit1approved', 'dunit1rejected', 'holdApproved', 'holdRejected']) ? 'active' : '' ?>">
                        <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                            data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <!-- leave   -->
                                    <div class="dropend">
                                        <a class="dropdown-item dropdown-toggle <?= in_array($current_page, ['dunit1approved', 'dunit1rejected']) ? 'active' : '' ?>"
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="/elms/dunit1approved"
                                                class="dropdown-item <?= in_array($current_page, ['dunit1approved']) ? 'active' : '' ?>">
                                                <span>បានអនុម័ត</span>
                                            </a>
                                            <a href="/elms/dunit1rejected"
                                                class="dropdown-item <?= in_array($current_page, ['dunit1rejected']) ? 'active' : '' ?>">
                                                <span>មិនអនុម័ត</span>
                                            </a>
                                        </div>
                                    </div>
