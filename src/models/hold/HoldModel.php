...
class HoldModel
{
    ...
    public function createHoldRequest($data)
    {
        ...
        $sql = "INSERT INTO $this->tblholds (user_id, start_date, end_date, reason, attachment, duration, type, color, created_at) 
                VALUES (:user_id, :start_date, :end_date, :reason, :attachment, :duration, :type, :color, NOW())";
